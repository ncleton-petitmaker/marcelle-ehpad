    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white font-[var(--font-inter)] selection:bg-[#C8A97E]/30 selection:text-white">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 h-[72px] backdrop-blur-xl bg-[#0A0A0A]/80 border-b border-white/5">
        <div className="max-w-7xl mx-auto h-full flex items-center justify-between px-4 md:px-8 lg:px-16">
          ...
          <DemoModal className="group inline-flex items-center gap-2 bg-white text-[#0A0A0A] px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-gray-100 transition-all duration-300 cursor-pointer">
            Demander une démo
        ...
        <div className="max-w-7xl mx-auto w-full px-4 md:px-8 lg:px-16 pt-16 md:pt-24 lg:pt-32 pb-12 flex-1 flex flex-col relative z-10">
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <DemoModal className="group inline-flex items-center gap-2 bg-white text-[#0A0A0A] px-7 py-3.5 rounded-xl font-medium text-[15px] hover:bg-gray-100 transition-all duration-300 shadow-[0_2px_8px_rgba(0,0,0,0.12)] cursor-pointer">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
          <BentoCard variant="white" className="relative overflow-hidden">
            ...
            <div className="relative z-10 py-16 md:py-20 lg:py-24 px-8 md:px-16 text-center">
              ...
              <div className="mt-10">
                <DemoModal className="group inline-flex items-center gap-2 bg-[#0A0A0A] text-white px-8 py-4 rounded-xl font-medium text-[15px] hover:bg-[#1A1A1A] transition-all duration-300 shadow-[0_2px_8px_rgba(0,0,0,0.15)] cursor-pointer">
                  Demander une démo <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                </DemoModal>
              </div>
