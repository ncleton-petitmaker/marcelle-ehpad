        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
          <BentoCard variant="white" className="relative overflow-hidden">
            ...
            <div className="relative z-10 py-16 md:py-20 lg:py-24 px-8 md:px-16 text-center">
              ...
              <div className="mt-10">
                <a href="mailto:contact@marcelle.ai?subject=Demande%20de%20d%C3%A9mo%20Marcelle" className="group inline-flex items-center gap-2 bg-[#0A0A0A] text-white px-8 py-4 rounded-xl font-medium text-[15px] hover:bg-[#1A1A1A] transition-all duration-300 shadow-[0_2px_8px_rgba(0,0,0,0.15)]">
                  Demander une démo <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                </a>
              </div>
