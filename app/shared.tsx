      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
            ...
            <p className="mt-3 text-sm text-white/30 max-w-md">L&apos;agent IA pour le medico-social. Transmissions, formation video et lien familles — le quotidien des professionnels, simplifie.</p>
          </div>
